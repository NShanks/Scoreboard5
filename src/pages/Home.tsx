...
export function displayTournament(){
    // console.log("This is being activated form the home page")
    // console.log(finalTourney)
    // console.log(finalTourney.get('games'))
    // console.log(finalTourney.get('games').size)
    let score = 0
    ...
    for (let y = 0; y < finalTourney.get('games').size; y++){ // for the number of games, make a wz game id input
    ...
    for (let i = 1; i <= finalTourney.get('teams'); i++){ // This creates the number of teams, a vertical stack, children of bracketContainer
